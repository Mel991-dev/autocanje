  ...
  const cargarComprobante = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_URL}/compras/${id}/comprobante`,
        {
          headers: {
    ...
    return (
      <div className="comprobante-container">
        ...
        <div className="error-container">
          ...
          <p>{error}</p>
          <button onClick={() => navigate('/')} className="btn btn-primary volver-inicio">
            Volver al Inicio
          </button>
        </div>
        <Footer />
          ...
          <div className="comprobante-card">
            ...
            <div className="email-notice">
              ...
              <div>
                ...
                <p className="notice-text">
                  Hemos enviado un comprobante digital a <strong>{compra.email}</strong>
                </p>
              </div>
            </div>
            ...
            <section className="comprobante-section">
              ...
              <div className="info-grid">
                <div>
                  <strong>Nombre:</strong> {compra.primer_nombre} {compra.primer_apellido}
                </div>
                <div>
                ...
                {compra.detalles && compra.detalles.map((item, index) => (
                  <div key={index} className="producto-item">
                    ...
                    <div className="producto-info">
                      <p className="producto-nombre">{item.nombre_producto}</p>
                      <p className="producto-categoria">{item.nombre_categoria}</p>
                      <p className="producto-cantidad">Cantidad: {item.cantidad}</p>
                      <p className="producto-precio">{formatPrice(item.subtotal_detalle)}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <section className="comprobante-section">
              <div className="totales">
                ...
                <div className="total-row total-final">
                  ...
                  <span className="valor-final">{formatPrice(compra.total)}</span>
                </div>
                {compra.pago && (
              ...
              <div className="entrega-card">
                ...
                <div>
                  ...
                  <p className="entrega-tiempo">
                    Tiempo estimado: <strong>{compra.compra_premium ? '1-3' : '3-7'} días hábiles</strong>
                  </p>
                  <p className="entrega-nota">
                    Puedes rastrear tu pedido desde tu perfil
                  </p>
                </div>
              </div>
            </section>
